...
from server4b import CommanderGUI  # Import the CommanderGUI class
...
class SystemAuthGUI:
    ...
    def show_login_screen(self) -> None:
        ...
        title = tk.Label(
            container,
            text="Commander Authentication System",
...
if __name__ == "__main__":
    def on_login_success(user_type, username):
        ...
        commander_root = tk.Tk()
        commander_gui = CommanderGUI(commander_root)
        commander_root.protocol("WM_DELETE_WINDOW", lambda: on_commander_close(commander_root))
        commander_root.mainloop()

    def on_commander_close(commander_root):
        commander_root.destroy()
